...
from webcore.navigation.conf import settings
...
#        r += '</span>'
    ...
    def changelist_view(self, request, extra_context=None, *args, **kwargs):
        ...
        extra_context['FEINCMS_ADMIN_MEDIA'] = settings.ADMIN_MEDIA
        extra_context['FEINCMS_ADMIN_MEDIA_HOTLINKING'] = settings.ADMIN_MEDIA_HOTLINKING
