...
// jQueryfied and scoped by Maxime Haineault
// Modified: 2011.08.13
...
(function(){
    ...
    BigNumber.prototype.set = function(n){
    ...
    BigNumber.prototype.intPart = function(){
    ...
    BigNumber.prototype.round = function(){
        ...
        if(b.length > p){
            n && (r == BigNumber.DOWN ? false : r == BigNumber.UP ? true : r == BigNumber.CEIL ? !this._s
            : r == BigNumber.FLOOR ? this._s : r == BigNumber.HALF_UP ? n >= 5 : r == BigNumber.HALF_DOWN ? n > 5
            : r == BigNumber.HALF_EVEN ? n >= 5 && b[p - 1] & 1 : false) && this.add(x);
